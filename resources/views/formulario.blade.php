                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('formulario.procesar') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="numero_cuenta" class="block mt-1 w-full" type="text" name="numero_cuenta" :value="old('numero_cuenta')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="saldo" class="block mt-1 w-full" type="number" name="saldo" :value="old('saldo')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="empleador" class="block mt-1 w-full" type="text" name="empleador" :value="old('empleador')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="ingresos" class="block mt-1 w-full" type="number" name="ingresos" :value="old('ingresos')" required />
                        ...
                        <div class="mt-4">
                            <label for="autorizacion_datos" class="inline-flex items-center">
                                <input id="autorizacion_datos" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="autorizacion_datos" value="1" required>
                        ...
                        <div class="mt-4">
                            <label for="consentimiento_comunicaciones" class="inline-flex items-center">
                                <input id="consentimiento_comunicaciones" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="consentimiento_comunicaciones" value="1" required>
